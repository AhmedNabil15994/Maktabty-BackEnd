...
class PermissionsTableSeeder extends Seeder
{
    ...
    private $permissions = [
        ...
        'service_categories' => [
            'display_name' => ['ar' => 'أقسام الخدمات', 'en' => 'Service Categories'],
            'single' => false,
        ],
        'services' => [
            'display_name' => ['ar' => 'الخدمات', 'en' => 'Services'],
            'single' => false,
        ],
        'service_orders' => [
            'display_name' => ['ar' => 'طلبات الخدمات', 'en' => 'Service Orders'],
            'single' => false,
        ],
        'educational_institutions' => [
            'display_name' => ['ar' => 'المؤسسات التعليمية', 'en' => 'Educational Institutions'],
            'single' => false,
        ],
        'barcode' => [
