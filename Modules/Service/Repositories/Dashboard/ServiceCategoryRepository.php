...
class ServiceCategoryRepository
{
    ...
    public function __construct()
    {
        ...
        $this->exportFileName = 'service_categories';
    }
    ...
    public function create($request)
    {
        ...
        try {
            $category = $this->category->create([
                'image' => $request->image ? Attachment::addAttachment($request['image'], 'service_categories') : url(config('setting.logo')),
                'banner_image' => $request->banner_image ? Attachment::addAttachment($request['banner_image'], 'service_categories') : null,
                ...
                'service_category_id' => ($request->service_category_id != "null" && $request->service_category_id != 1) ? $request->service_category_id : null,
    ...
    public function update($request, $id)
    {
        ...
        try {
            $category->update([
                'banner_image' => $request->banner_image ? Attachment::addAttachment($request['banner_image'], 'service_categories') : $category->banner_image,
                'image' => $request->image ? Attachment::updateAttachment($request['image'], $category->image, 'service_categories') : $category->image,
