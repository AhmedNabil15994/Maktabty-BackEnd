...
@section('title', __('service::dashboard.service_categories.routes.index'))
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('service::dashboard.service_categories.routes.index')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        @permission('add_service_categories')
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.service_categories.create')) }}"
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('service::dashboard.service_categories.datatable.image')}}</th>
                                    <th>{{__('service::dashboard.service_categories.datatable.status')}}</th>
                                    <th>{{__('service::dashboard.service_categories.datatable.title')}}</th>
                                    <th>{{__('service::dashboard.service_categories.datatable.type')}}</th>
                                    <th>{{__('service::dashboard.service_categories.datatable.created_at')}}</th>
                                    <th>{{__('service::dashboard.service_categories.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.service_categories.deletes')) }}')">
...
@section('scripts')
    ...
    @include('apps::dashboard.components.datatable.image-uploading.scripts',['uploading_route' => route('dashboard.service_categories.update.photo')])

    @include('apps::dashboard.components.import-excel-scripts',[
        'route' => route('dashboard.service_categories.import.excel')
    ])
    <script>
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.service_categories.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
...
responsivePriority: 1,
                            width: '13%',
                            title: '{{__('service::dashboard.service_categories.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.service_categories.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.service_categories.destroy", ":id") }}';
                                ...
                                var buttons = `
                                    @permission('edit_service_categories')
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.service_categories.export' , 'print'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.service_categories.export' , 'pdf'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.service_categories.export' , 'excel'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
