    ...
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true"
            ...
            @if (Module::isEnabled('Catalog'))
                <li class="nav-item  open">
                    ...
                    <ul class="sub-menu" style="display: block;">
                        ...
                        @permission('show_educational_institutions')
                            <li class="nav-item {{ active_menu('educational-institutions') }}">
                                <a href="{{ url(route('dashboard.educational_institutions.index')) }}"
                                    class="nav-link nav-toggle">
                                    <i class="icon-settings"></i>
                                    <span class="title">{{ __('apps::dashboard.aside.educational_institutions') }}</span>
                                    <span class="selected"></span>
                                </a>
                            </li>
                        @endpermission
            ...
            @if (Module::isEnabled('Service'))
                <li class="nav-item  {{ active_slide_menu(['services', 'service-orders', 'service-categories']) }}">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="icon-settings"></i>
                        <span class="title">{{ __('apps::dashboard.aside.tab.services') }}</span>
                        <span
                            class="arrow {{ active_slide_menu(['services', 'service-orders', 'service-categories']) }}"></span>
                        <span class="selected"></span>
                    </a>
                    <ul class="sub-menu">

                        @permission('show_service_categories')
                            <li class="nav-item {{ active_menu('service-categories') }}">
                                <a href="{{ url(route('dashboard.service_categories.index')) }}"
                                    class="nav-link nav-toggle">
                                    <i class="icon-settings"></i>
                                    <span class="title">{{ __('apps::dashboard.aside.service_categories') }}</span>
                                    <span class="selected"></span>
                                </a>
                            </li>
                        @endpermission
                        ...
                        @permission('show_services')
                            <li class="nav-item {{ active_menu('services') }}">
                                <a href="{{ url(route('dashboard.services.index')) }}" class="nav-link nav-toggle">
                                    <i class="icon-settings"></i>
                                    <span class="title">{{ __('apps::dashboard.aside.services') }}</span>
                                    <span class="selected"></span>
                                </a>
                            </li>
                        @endpermission
                        ...
                        @permission('show_service_orders')
                            <li class="nav-item {{ active_menu('service-orders') }}">
                                <a href="{{ url(route('dashboard.service_orders.index')) }}" class="nav-link nav-toggle">
                                    <i class="icon-settings"></i>
                                    <span class="title">{{ __('apps::dashboard.aside.service_orders') }}</span>
                                    <span class="selected"></span>
                                </a>
                            </li>
                        @endpermission
            ...
            <li
                class="nav-item  {{ active_slide_menu(['coupons', 'slider', 'banner', 'notifications', 'app-homes', 'advertising-groups', 'subscribe', 'social']) }}">
                <a href="javascript:;" class="nav-link nav-toggle">
                    <i class="icon-settings"></i>
                    <span class="title">{{ __('apps::dashboard.aside.tab.marketing') }}</span>
                    <span
                        class="arrow {{ active_slide_menu(['coupons', 'slider', 'banner', 'notifications']) }}"></span>
                    <span class="selected"></span>
                </a>
                <ul class="sub-menu">
            ...
            <li class="nav-item  {{ active_slide_menu(['pages']) }}">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span
                        class="arrow {{ active_slide_menu(['pages', 'app-homes', 'advertising-groups', 'subscribe']) }}"></span>
                    <span class="selected"></span>
                </a>
                <ul class="sub-menu">
                ...
                <li class="nav-item  {{ active_slide_menu(['labels', 'barcode-setting', 'pos-orders']) }}">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item {{ active_menu('pos-orders') }}">
                            <a href="{{ url(route('dashboard.pos_orders.index')) }}" class="nav-link nav-toggle">
                                <i class="icon-settings"></i>
