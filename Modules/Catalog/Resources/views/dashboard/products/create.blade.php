                                ...
                                @foreach ($productTypes::getConstList() as $type)
                                    <label class="mt-radio">
                                        <input type="radio" name="product_type" value="{{ $type }}"
                                            ...
                                            {{ $type == $productTypes::__default ? 'checked' : '' }}>
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="brand_id" id="brand"
                                                        class="form-control select2-allow-clear" data-name="brand_id">
                                                        <option value=""></option>
                                            ...
                                            {!! field()->checkBox('all_countries', __('catalog::dashboard.products.form.all_countries')) !!}

                                            <div id="select_countries" style="display:block">
                                                {!! field()->multiSelect(
                                                    'countries',
