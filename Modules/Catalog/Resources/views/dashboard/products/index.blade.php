                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label class="control-label">
                                                                {{__('catalog::dashboard.products.form.product_type')}}
                                                            </label>
                                                            <div class="mt-radio-list">
                                                                <label class="mt-radio">
                                                                    {{__('catalog::dashboard.products.form.types.product')}}
                                                                    <input type="radio" value="product" name="product_type" />
                                                                    <span></span>
                                                                </label>
                                                                <label class="mt-radio">
                                                                    {{__('catalog::dashboard.products.form.types.note')}}
                                                                    <input type="radio" value="note" name="product_type" />
                                                                    <span></span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="categories" class="form-control select2-allow-clear">
                                                                <option value="">
                                                                    ---
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'sku', className: 'dt-center', orderable: false},
