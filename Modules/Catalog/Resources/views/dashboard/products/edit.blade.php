...
@inject('productTypes', 'Modules\Catalog\Enums\ProductType')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-check text-center">
                            <div class="mt-radio-inline">
                                @foreach ($productTypes::getConstList() as $type)
                                    <label class="mt-radio">
                                        <input type="radio" name="product_type" value="{{ $type }}"
                                            onclick="onProductTypeChange('{{ $type }}');"
                                            {{ $type == $product->product_type ? 'checked' : '' }}>
                                        {{ __('catalog::dashboard.products.form.types.' . $type) }}
                                        <span></span>
                                    </label>
                                @endforeach
                            </div>
                                    ...
                                    <div id="collapse_2_1" class="panel-collapse in">
                                        <div class="panel-body">
                                            <ul class="nav nav-pills nav-stacked">
                                                ...
                                                <li class="">
                                                    <a href="#categories" data-toggle="tab" id="categoriesTab"
                                                        style="display: {{ $product->product_type == $productTypes::__default ? 'block' : 'none' }}">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        @foreach (config('translatable.locales') as $code)
                                            <div id="global_setting{{ $code }}"
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2">
                                                            {{ __('catalog::dashboard.products.form.delivery_time') }}
                                                            - {{ $code }}
                                                        </label>
                                                        <div class="col-md-9">
                                                            <input type="text" name="delivery_time[{{ $code }}]"
                                                                class="form-control"
                                                                data-name="delivery_time.{{ $code }}"
                                                                value="{{ $product->getTranslation('delivery_time', $code) }}">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2">
                                                            {{ __('catalog::dashboard.products.form.store_location') }}
                                                            - {{ $code }}
                                                        </label>
                                                        <div class="col-md-9">
                                                            <input type="text"
                                                                name="store_location[{{ $code }}]"
                                                                class="form-control"
                                                                data-name="store_location.{{ $code }}"
                                                                value="{{ $product->getTranslation('store_location', $code) }}">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group" id="educationalInstitutionSection"
                                                style="display: {{ $product->product_type == $productTypes::__default ? 'none' : 'block' }}">
                                                <label class="col-md-2">
                                                    {{ __('catalog::dashboard.products.form.educational_institution') }}
                                                </label>
                                                <div class="col-md-9">
                                                    <select name="educational_institution_id" id="brand"
                                                        class="form-control select2-allow-clear"
                                                        data-name="educational_institution_id">
                                                        <option value=""></option>
                                                        @foreach ($activeEducationalInstitutions as $institution)
                                                            <option value="{{ $institution['id'] }}"
                                                                {{ $institution['id'] == $product->educational_institution_id ? 'selected' : '' }}>
                                                                {{ $institution->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            {!! field()->checkBox(
                                                ...
                                                $product->all_countries,
                                                [$product->all_countries == 1 ? 'checked' : '' => ''],
                                            ) !!}
                                            <div id="select_countries"
                                                style="display: {{ $product->all_countries == 1 ? 'none' : 'block' }}">
                                                {!! field()->multiSelect(
                                                    'countries',
                                                    __('catalog::dashboard.products.form.countries'),
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="checkbox" class="make-switch"
                                                            id="show_product_website" data-size="small"
                                                            name="show_product_website"
...
@section('scripts')
    ...
    <script>
        function onProductTypeChange(value) {
            let defaultValue = '{{ $productTypes::__default }}'; // single
            if (value == defaultValue) { // product
                $('#categoriesTab').show();
                $('#categoriesTabContent').show();
                $('#educationalInstitutionSection').hide();
            } else { // note
                $('#categoriesTab').hide();
                $('#categoriesTabContent').hide();
                $('#educationalInstitutionSection').show();
            }

            var id = '{{ request()->route('id') ?? null }}';
            getRelatedProducts(value, id);
        }

        function getRelatedProducts(type, id) {
            let data = {
                'id': id,
                'type': type,
            };
            ...
            $.ajax({
                method: "GET",
                dataType: 'json',
                url: '{{ route('dashboard.products.get_related_products') }}',
                data: data,
                success: function(data) {
                    buildRelatedProductsDropdown(data);
                },
                error: function(data) {
        ...
        function buildRelatedProductsDropdown(data) {
            let id = 'relatedProductsSelect',
                label = '';
